...
export const deleteOrg = (orgId: string) => POST('/proApi/support/user/team/org/delete', { orgId });

export const putMoveOrg = (data: putMoveOrgType) =>
  POST('/proApi/support/user/team/org/move', data);

export const putUpdateOrg = (data: putUpdateOrgData) =>
  POST('/proApi/support/user/team/org/update', data);

// org members
export const putUpdateOrgMembers = (data: putUpdateOrgMembersData) =>
  POST('/proApi/support/user/team/org/updateMembers', data);
...
export const deleteOrgMember = (orgId: string, tmbId: string) =>
  POST('/proApi/support/user/team/org/deleteMember', { orgId, tmbId });
